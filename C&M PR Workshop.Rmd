...
pop_cm<-pop%>%
  ...
  mutate(AgeGroup = case_when(Age %in% c("60", "61", "62", "63", "64", "65", "66", "67", "68", "69",
                                         ...
                                         "90+") ~ "60+",
                              TRUE ~ "Under 60"))%>%
  group_by(LSOA.Code, LSOA.Name, `LA.Code.(2018.boundaries)`, `LA.name.(2018.boundaries)`, `LA.Code.(2021.boundaries)`, `LA.name.(2021.boundaries)`, AgeGroup)%>%
